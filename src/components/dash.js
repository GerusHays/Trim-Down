      ...
      <div className="flex flex-col py-4 w-11/12 md:w-5/6 mx-auto">
        ...
        <div className="card  bg-white shadow-xl mb-8">
          <div className="card-body">
            ...
            <div className="flex flex-row gap-5 pb-2">
              <p>Mon</p>
              <progress class="progress progress-success h-6" value="23" max="100"></progress>
            </div>
            <div className="flex flex-row gap-6 pb-2">
              <p>Tue</p>
              <progress class="progress progress-success h-6" value="42" max="100"></progress>
            </div>
            <div className="flex flex-row gap-5 pb-2">
              <p>Wed</p>
              <progress class="progress progress-success h-6" value="45" max="100"></progress>
            </div>
            <div className="flex flex-row gap-6 pb-2">
              <p>Thu</p>
              <progress class="progress progress-success h-6" value="69" max="100"></progress>
            </div>
            <div className="flex flex-row gap-8 pb-2">
              <p>Fri</p>
              <progress class="progress progress-success h-6" value="46" max="100"></progress>
            </div>
            <div className="flex flex-row gap-7 pb-2">
              <p>Sat</p>
              <progress class="progress progress-success h-6" value="100" max="100"></progress>
            </div>
          </div>
        </div>
